      ...
      >
        ...
        <div class="d-block mt-6">
          <a
            ...
            class="link d-flex justify-center align-center mt-2 px-4 py-2"
            :title="company.name"
            :href="company.link"
            target="_blank"
          ...
          >
            <v-lazy>
              <img
                class="d-block"
                :src="require(`~/assets/images/kart15th/cooperator/${company.logo.file}`)"
...
import cooperators from '~/data/kart15th/cooperators'
