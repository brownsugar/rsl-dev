  ...
  data: () => ({
    schedules: [
      ...
      },
      {
        ...
        time: '19:00',
        title: '4 強賽、勝組賽',
        content: '4 強賽採雙敗淘汰賽制，A/B 兩個組別分別進行對決，各組勝利隊伍晉級勝組賽、落敗隊伍進入敗組賽。<br>每個場次進行三個回合，分別為團體競速賽、團體道具賽七戰四勝，以及個人競速賽單挑五戰三勝。'
      },
      {
        dates: '08/29',
        time: '14:30',
        title: '敗組賽、準決賽、總決賽 / 台韓交流賽',
        content: '首先進行敗組賽，勝出隊伍晉級準決賽、落敗隊伍則為本季聯賽殿軍，接著進行準決賽，勝利隊伍晉級總決賽，落敗隊伍則為本季聯賽季軍。<br>中場休息後晚上 7:00 總決賽進行本季聯賽最終對決，勝利隊伍即為 RSL 夢想盃跑跑聯賽第二季冠軍，落敗隊伍則為亞軍。<br>每個場次進行三個回合，分別為團體競速賽、團體道具賽七戰四勝，以及個人競速賽單挑五戰三勝。<br>緊接著登場台韓交流賽，將由本季聯賽冠軍隊伍對上韓國職業聯賽隊伍，採用專屬賽制，更多資訊請至官網「台韓交流賽」專區查詢。'
      }
    ]
  }),
  methods: {
